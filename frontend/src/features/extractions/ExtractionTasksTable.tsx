...
export function ExtractionTasksTable() {
  ...
  const onFilterChange = useCallback((filter: any) => dispatch(setExtractionTaskTableFilter(filter)), [dispatch]);
  const onSortChange = useCallback((sort: any) => dispatch(setExtractionTaskTableSort(sort)), [dispatch]);
