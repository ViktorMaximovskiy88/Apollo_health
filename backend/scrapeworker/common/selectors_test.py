...
def test_selector_href_javascript_keyword():
   selector = filter_by_href(javascript=True, keywords=["dog"])
   assert selector == ['a[href^="javascript:"]', 'a[href*="dog"]']
   

def test_selector_href_extension_keyword():
   selector = filter_by_href(extensions=["pdf"], keywords=["dog"])
   assert selector == ['a[href$=".pdf"]', 'a[href*="dog"]']

def test_selector_href_javascript_extension_keyword():
   selector = filter_by_href(javascript=True, extensions=["pdf"], keywords=["dog"])
   assert selector == ['a[href^="javascript:"]',
                       'a[href$=".pdf"]', 'a[href*="dog"]']
...
def test_selector_href_keywords():
   selector = filter_by_href(keywords=["dog", "cat"])
...
def test_hidden_value_extension_keyword():
   selector = filter_by_hidden_value(extensions=["pdf"], keywords=["dog"])
   assert selector == ['input[type="hidden"][value$=".pdf"]', 'input[type="hidden"][value*="dog"]']


def test_hidden_value_extensions():
   selector = filter_by_hidden_value(extensions=["pdf", "docx"])
   assert selector == ['input[type="hidden"][value$=".pdf"]', 'input[type="hidden"][value$=".docx"]']


def test_hidden_value_keywords():
   selector = filter_by_hidden_value(keywords=["dog", "cat"])
   assert selector == ['input[type="hidden"][value*="dog"]', 'input[type="hidden"][value*="cat"]']
